...
**      0      16     Header string (SQLITE_FILE_HEADER)
...
**
** Standard builds can change this value at compile-time by specifying
** -DSQLITE_FILE_HEADER="...". Matchertext builds use a fixed signature.
** The header must be exactly 16 bytes including the zero-terminator.
*/
#ifdef SQLITE_ENABLE_MATCHERTEXT /* 123456789 123456 */
#  ifdef SQLITE_FILE_HEADER
#    error SQLITE_FILE_HEADER cannot override the matchertext file signature
#  endif
#  define SQLITE_FILE_HEADER "Matchertext db1"
#elif !defined(SQLITE_FILE_HEADER)
